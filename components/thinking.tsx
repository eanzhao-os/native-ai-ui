...
export default function ThinkingState({
  ...
  const lang = useLang("thinking", propLang);
  const zh = lang === "zh";
  ...
  return (
    <div key={variant + lang} className="flex min-h-[176px] w-full max-w-95 flex-col">
      {/* Header */}
      <button
        type="button"
